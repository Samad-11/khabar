                        ...
                        <div className="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                            ...
                            <div className="col-xs-12 col-xl-6 order-2 order-xl-1">
                                <ul className="nav justify-content-center">
                                    <li className="nav-item">
                                        <a className="disabled nav-link link-secondary px-2 px-md-3" href="#!">About</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="disabled nav-link link-secondary px-2 px-md-3" href="#!">Contact</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="disabled nav-link link-secondary px-2 px-md-3" href="#!">Advertise</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="disabled nav-link link-secondary px-2 px-md-3" href="#!">Terms</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="disabled nav-link link-secondary px-2 px-md-3" href="#!">Privacy</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-xs-12 col-sm-6 col-xl-3 order-1 order-xl-2">
                                <ul className="nav justify-content-center justify-content-sm-end">
                                    <li className="nav-item">
                                        <a className="disabled nav-link link-dark px-3" href="#!">
                        ...
                        <div className="row">
                            <div className="col">
                                ...
                                <div className="credits text-secondary text-center mt-2 fs-7">
                                    Built by <a href="https://github.com/Samad-11" target='_blank' className="link-secondary text-decoration-none">Abdus Samad</a> with <span className="text-primary"></span>
                                </div>
                            </div>
                        </div>
                    </div>
